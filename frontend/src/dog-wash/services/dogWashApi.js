...
export const SERVICES = [
  {
    ...
    description: "Our basic wash is perfect for a quick refresh. It includes a thorough warm water scrub with premium pH-balanced pet shampoos, a deep coat rinse, nail inspection, towel wrap, and high-velocity styling dry to leave your dog looking clean and smelling fresh.",
  ...
  },
  {
    ...
    description: "An elevated cleaning treatment that goes beyond a basic wash. Ideal for dogs with shedding undercoats or dry skin. Includes deep coat conditioner treatments, blow dry, thorough nail clipping, and gentle ear canal flushing to keep your pet clean from head to tail.",
  ...
  },
  {
    ...
    description: "Our flagship grooming program. Our master stylists perform a full body breed-standard haircut or custom style request. Includes a premium shampoo wash, aloe conditioning, blow dry, full brush out, sanitary trim, nail clip, ear cleaning, and refreshing cologne.",
