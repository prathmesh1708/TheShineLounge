    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-4 my-6">
          ...
          <span className="text-[10px] font-extrabold text-gray-400 uppercase tracking-[0.2em]">OR</span>
          <div className="flex-1 h-px bg-gray-200" />
        </div>
        ...
        <motion.button
          ...
          className="w-full h-[52px] rounded-[18px] border border-gray-200 bg-white flex items-center justify-center gap-3 font-bold text-sm text-gray-700 transition-all duration-300 hover:border-gray-300"
        >
        ...
        <motion.button
          type="button"
          whileHover={{ y: -1, boxShadow: '0 8px 24px rgba(0,0,0,0.06)' }}
          whileTap={{ scale: 0.98 }}
          onClick={() => alert('Microsoft integration is in development.')}
          className="w-full h-[48px] mt-3 rounded-[18px] border border-gray-100 bg-gray-50/50 flex items-center justify-center gap-2.5 font-semibold text-xs text-gray-500 transition-all duration-300 hover:bg-white hover:border-gray-200"
        >
