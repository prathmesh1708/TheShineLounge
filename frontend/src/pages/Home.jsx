...
export default function Home() {
  ...
  return (
    <div className="app-mobile-dashboard" ref={contentRef} style={{ marginTop: '-0.75rem' }}>
      
      {/* Top Search & Bell Row */}
      <div className="top-search-bell-row" style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', width: '100%' }}>
