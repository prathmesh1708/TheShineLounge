...
export default function CarDetailingTestimonials({ reviews = [] }) {
  ...
  return (
    <div className="relative bg-white border border-zinc-200/85 rounded-24 p-8 md:p-12 text-zinc-800 shadow-premium overflow-hidden">
      ...
      {/* Background decoration quote mark */}
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-t border-zinc-100 pt-6 mt-2">
            ...
            <div className="flex items-center gap-4">
              <img
                ...
                className="w-12 h-12 rounded-full object-cover border-2 border-luxury-emerald"
              />
              <div>
                <h4 className="font-extrabold text-base text-zinc-800">{currentReview.name}</h4>
      ...
      <div className="absolute right-8 bottom-8 flex gap-2">
        <button
          onClick={handlePrev}
          className="p-2 bg-zinc-150 hover:bg-zinc-200 text-zinc-700 rounded-full transition-all border border-zinc-250 shadow-sm"
        >
