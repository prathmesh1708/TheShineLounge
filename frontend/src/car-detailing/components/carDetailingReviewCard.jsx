...
export default function CarDetailingReviewCard({ review }) {
  return (
    <div className="bg-white border border-zinc-200/85 rounded-24 p-6 flex flex-col justify-between gap-4 text-zinc-800 shadow-premium">
      ...
      <div className="flex justify-between items-start gap-4">
        <div className="flex items-center gap-3">
          ...
          />
          <div>
            <h4 className="font-bold text-sm text-zinc-800">{review.name}</h4>
      ...
      {/* Review Body */}
      <p className="text-zinc-600 text-xs md:text-sm leading-relaxed flex-grow italic">
        "{review.comment}"
      </p>
      ...
      <div className="border-t border-zinc-100 pt-3.5 flex flex-wrap justify-between items-center gap-2 text-[10px] uppercase font-bold tracking-wider">
        <span className="text-luxury-emerald">{review.service}</span>
