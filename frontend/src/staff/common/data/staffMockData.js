...
export const mockAssignedJobs = [
  // Drive-Through Cafe Orders
  {
    ...
    serviceKey: 'drive-through-cafe',
    serviceName: 'Drive-Through Cafe',
    planName: 'Commuter Cold Brew + Breakfast Burrito',
    itemsSummary: '1x Commuter Cold Brew (16 oz), 1x Drive-Through Breakfast Burrito',
    items: [
      { name: 'Commuter Cold Brew', qty: 1, price: 4.95 },
      { name: 'Drive-Through Breakfast Burrito', qty: 1, price: 8.50 }
    ],
    ...
    status: 'Preparing',
    stepIndex: 1,
    notes: 'Extra ice in cold brew, mild salsa in burrito',
    photos: ['https://images.unsplash.com/photo-1517701604599-bb29b565090c?auto=format&fit=crop&w=400&q=80'],
    createdAt: '2026-08-03 01:50 PM'
  },
  {
    id: 'DT-2026-102',
    customerId: 'CUST-002',
    ...
    serviceKey: 'drive-through-cafe',
    serviceName: 'Drive-Through Cafe',
    planName: 'Roadtrip Caramel Latte + Cinnamon Roll',
    itemsSummary: '1x Roadtrip Caramel Latte, 1x Glazed Morning Cinnamon Roll',
    items: [
      { name: 'Roadtrip Caramel Latte', qty: 1, price: 5.45 },
      { name: 'Glazed Morning Cinnamon Roll', qty: 1, price: 4.50 }
    ],
    ...
    gst: 24.75,
    total: 519.75,
    paymentMode: 'Card at Window',
    paymentStatus: 'Paid',
    status: 'Ready for Pickup',
    stepIndex: 2,
    notes: 'Warm cinnamon roll before packing',
    photos: [],
    createdAt: '2026-08-03 02:00 PM'
  },
  {
    id: 'DT-2026-103',
    customerId: 'CUST-003',
    ...
    serviceKey: 'drive-through-cafe',
    serviceName: 'Drive-Through Cafe',
    planName: 'Nitro Sweet Cream + Brioche Bacon Club',
    itemsSummary: '1x Nitro Vanilla Sweet Cream, 1x Brioche Bacon & Egg Club',
    items: [
      { name: 'Nitro Vanilla Sweet Cream', qty: 1, price: 5.75 },
      { name: 'Brioche Bacon & Egg Club', qty: 1, price: 9.25 }
    ],
    vehicleNo: 'MH-03-EF-9988',
    ...
    status: 'Confirmed',
    stepIndex: 0,
    notes: 'Cup holder tray requested',
    photos: [],
    createdAt: '2026-08-03 02:10 PM'
  },
  {
    id: 'DT-2026-104',
    customerId: 'CUST-004',
    ...
    serviceKey: 'drive-through-cafe',
    serviceName: 'Drive-Through Cafe',
    planName: 'Spiced Chai Milk Tea + Blueberry Oat Muffin',
    itemsSummary: '1x Spiced Chai Milk Tea, 1x Blueberry Oat Muffin',
    items: [
      { name: 'Spiced Chai Milk Tea', qty: 1, price: 5.20 },
      { name: 'Blueberry Oat Muffin', qty: 1, price: 4.25 }
    ],
    ...
    status: 'Completed',
    stepIndex: 3,
    notes: 'Delivered at window lane 1',
    photos: [],
  ...
  },
  {
    ...
    serviceKey: 'dog-wash',
    serviceName: 'Dog Wash',
    planName: 'Classic Hydrobath',
    vehicleNo: 'Beagle (Max)',
    vehicleModel: 'Pet',
    vehicleType: 'Dog',
    staffId: 'STF-07',
    staffName: 'Sneha Rao',
    ...
    status: 'Confirmed',
    stepIndex: 0,
    notes: 'Warm water hydrobath + oatmeal shampoo.',
    photos: [],
    createdAt: '2026-07-20 05:30 PM'
  },
  {
    id: 'JOB-7009',
    customerId: 'CUST-009',
    ...
    serviceKey: 'dog-wash',
    serviceName: 'Dog Wash',
    planName: 'Deluxe Grooming & Nail Trim',
    vehicleNo: 'Pug (Leo)',
    vehicleModel: 'Pet',
    vehicleType: 'Dog',
    staffId: 'STF-08',
    staffName: 'Pooja Kulkarni',
    date: '2026-07-20',
    timeSlot: '07:00 PM',
    amount: 750,
    gst: 135.00,
    ...
    stepIndex: 6,
    notes: 'Full breed scissors haircut and nail grinding completed.',
    photos: [],
    createdAt: '2026-07-20 06:00 PM'
  },
